            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <Reveal direction="left">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm font-medium text-slate-400">Monitor all financial activities and payment streams</p>
                    </div>
                </Reveal>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-50">
                                ...
                                <th className="px-8 py-6">Entity Origin</th>
                                ...
                                <tr key={t._id} className="group hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td className="px-8 py-7">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full overflow-hidden border border-slate-100 shadow-sm bg-slate-100 flex items-center justify-center font-bold text-slate-500">
                                                {t.user?.name?.charAt(0) || <Globe size={18} />}
                                            </div>
                                            <div className="flex flex-col">
                                                <span className="text-sm font-bold text-slate-700">{t.user?.name || "System Entry"}</span>
                                                <span className="text-[10px] font-medium text-slate-400">Regular Member</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-7">
                                    ...
                                    <td className="px-8 py-7 text-center">
                                        <span className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider border ${getStatusStyle('finalized')}`}>
                                            Finalized
                                        </span>
                                    </td>

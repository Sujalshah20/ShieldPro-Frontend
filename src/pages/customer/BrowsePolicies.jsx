        ...
        <div className="min-h-screen bg-[#f8fafc] font-sans pb-12">
            ...
            <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-40">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-bold text-[#002b45]">Browse Policies</h1>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-8 pt-8">
                {/* Search & Filters */}
                <div className="bg-white p-4 rounded-xl border border-gray-200 flex flex-col md:flex-row gap-4 mb-8">
                    <div className="flex-1 relative">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={20} />
                        <input 
                            type="text" 
                            placeholder="Search for insurance policies, companies or keywords..." 
                            className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#002b45]/20 focus:border-[#002b45] transition-all"
                        />
                    </div>
                    <div className="flex gap-4">
                        <button className="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm font-medium text-gray-600 flex items-center justify-between min-w-[140px] hover:bg-gray-100 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                    {filteredPolicies.map((policy, index) => (
                        <motion.div 
                            ...
                            key={policy.id} 
                            className="bg-white rounded-2xl p-6 border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] relative flex flex-col"
                        >
                            {policy.tag && (
                            ...
                            <div className="w-16 h-16 bg-white rounded-2xl shadow-md border border-gray-50 flex items-center justify-center mb-6">
                                {policy.icon}
                            </div>

                            <h3 className="text-xl font-bold text-[#002b45] mb-1">{policy.title}</h3>
                            <p className="text-sm text-gray-500 mb-6">{policy.provider}</p>

                            ...
                            <div className="saas-card group relative overflow-hidden shadow-4xl hover:border-[#007ea7]/40 transition-all duration-1000 h-full flex flex-col p-14 border-2 border-slate-50 bg-white/50 backdrop-blur-md min-h-[500px] rounded-[4.5rem]">
                                ...
                                <div className="flex justify-between items-start mb-16 relative z-10">
                                    ...
                                    <div className="flex flex-col items-end gap-6">
                                        <div className={`px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-[6px] border-2 shadow-2xl italic flex items-center gap-4 ${p.status === 'Active' ? 'bg-emerald-50 text-emerald-600 border-emerald-50' : 'bg-slate-50 text-slate-400 border-slate-50'
                                            }`}>
                                    ...
                                    <div className="relative z-20 flex flex-col lg:flex-row justify-between gap-24 lg:gap-0">
                                        {claimProgress.map((step, i) => (
                                            <div key={i} className="flex items-center lg:flex-col gap-10 lg:gap-14 bg-white/0 lg:px-6 group/step">
                                                <div className={`w-24 h-24 rounded-[2.5rem] flex items-center justify-center transition-all duration-1000 shadow-4xl relative overflow-hidden group-hover/step:scale-110 ${step.completed ? 'bg-[#007ea7] text-white' :
